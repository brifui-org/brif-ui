export const theme = {
  ...
  base: {
    colors: {
      ...
      sys: {
        ...
        secondary: {
          DEFAULT: "ref.violet.700",
          foreground: "ref.white",
          disabled: "ref.violet.400",
          hover: "ref.violet.600",
          active: "ref.violet.800"
        },
        success: {
          DEFAULT: "ref.emerald.700",
          foreground: "sys.foreground",
          disabled: "ref.emerald.400",
          hover: "ref.emerald.600",
          active: "ref.emerald.800"
        },
        warning: {
        ...
        danger: {
          DEFAULT: "ref.red.500",
          foreground: "ref.white",
          disabled: "ref.red.400",
          hover: "ref.red.600",
          active: "ref.red.800"
        },
        background: { DEFAULT: "ref.white", hover: "ref.neutral.100" },
        border: { DEFAULT: "ref.neutral.200" },
        default: {
          DEFAULT: "ref.black",
          foreground: "ref.white",
          disabled: "ref.neutral.400",
  ...
  themeFile: { dir: "theme", name: "theme.ts" },
  themes: {
    light: { colors: {} },
    dark: {
      colors: {
        sys: {
          background: { DEFAULT: "ref.black", hover: "ref.neutral.900" },
          foreground: {
            DEFAULT: "ref.neutral.50",
            muted: "ref.neutral.600",
            disabled: "ref.neutral.400"
          },
          border: { DEFAULT: "ref.neutral.700" },
          primary: {
